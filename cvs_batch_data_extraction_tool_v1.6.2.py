        ...
        for item in os.listdir(selected_folder):
            ...
            for model in selected_models:
                ...
                for file_path in model_dict.get(model, []):
                    ...
                    if file_path.startswith(sub_folder):
...
def show_model_list(model_list):
    ...
    file_canvas.configure(
        scrollregion=(
            ...
            0,
            0,
            files_inner_frame.winfo_reqheight()
        )
    )

    file_canvas.yview_moveto(0)
...
def run_process():
    ...
    for task in tasks:
        ...
        elif task_type == "separate":

            folder_name = task[1]

            selected_files = task[2]
